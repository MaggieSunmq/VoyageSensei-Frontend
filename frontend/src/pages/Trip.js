...
//       // Update tripData if there's a change
//       setTripData((prevData) =>
//         JSON.stringify(prevData) !== JSON.stringify(data) ? data : prevData
//       );

//       // Stop polling if this was the initial load
//       if (isInitialLoad) {
...
//             isExpanded={true}
//             toggleExpand={() => {}}
//             notifyUpdate={handleUpdateNotification} // Trigger polling when ChatBox detects changes
//           />
//         </div>
//       </div>
//       <div className={styles.rightPanel}>
...
//         >
//           <h2>Trip Plan Details</h2>
//           <Itinerary tripData={tripData}  key={refreshKey} /> {/* Force re-render with key */}
//         </div>
...
//       {/* Right Panel: Map */}
//       <div className={styles.rightPanel}>
//         <Map tripData={tripData} key={refreshKey} /> {/* Force re-render with key */}
//         {/* Refresh Button */}
