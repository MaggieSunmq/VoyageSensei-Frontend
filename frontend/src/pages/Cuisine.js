...
function Cusine({ handleTagClick, selectedTags, dislikedTags, handleDislikedTagClick, activeTag }) {
  const options = [
  ...
  return (
    <Onboarding
      ...
      options={options}
      selectedTags={selectedTags} // Liked cuisines
      dislikedTags={dislikedTags} // Disliked cuisines
      handleTagClick={handleTagClick} // Liked tag handler
      handleDislikedTagClick={handleDislikedTagClick} // Disliked tag handler
      activeTag={activeTag}
      progress={66.67}
      nextPage="/"
    />
