...
//           console.log('No segment data found in API response');
//           setTravelTime([]);
//           return;
//         }
//         const segmentDurations = segments.map((segment) => Math.ceil(segment.duration / 60) );
//         //const segment = response.features[0].properties.segments;
//         //console.log(segment);
//       //);
//         //const travelTimeMinutes = travelTime.map((duration) =>
...
//   const starting_point = tripData[0];
//   const pois = tripData.slice(1, -1);
//   console.log(`print travel time ${travelTime}`);
//   const createNumberedIcon = (number) => {
//
//   return L.divIcon({
//     html: `
...
//       {travelTime&&pois.map((poi, index) => (
//         <Marker key={index} position={poi.coordinates} icon={createNumberedIcon(index + 1)}>
//           <Tooltip direction="top" offset={[0, -35]} permanent className="custom-tooltip">
//             <strong>{poi.name}</strong><br />
//             <>
//             Travel time from previous stop: <br />
//             {travelTime[index]} minutes
//             </>
//           </Tooltip>
//         </Marker>
//       ))}
//       {/* Route Polyline */}
//       {/*{route && <Polyline positions={route} color="blue" />}*/}</MapContainer>
//   );
// }
//
// export default Map;
